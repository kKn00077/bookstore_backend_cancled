    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('USE', '사용'), ('DELETED', '탈퇴'), ('DORMANT', '휴면')], default='USE', max_length=30, verbose_name='계정 상태')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='certification', to=settings.AUTH_USER_MODEL, verbose_name='유저 계정 정보')),
            ],
            options={
